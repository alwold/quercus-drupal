...
<?php include('/afs/asu.edu/www/asuthemes/latest/custom/d6/includes/asu_header_d6.inc.php'); ?>
  ...
  <?php endif; ?>
   ...
   <div id="main"><div id="main-inner" class="clear-block<?php if ($search_box or $primary_links or $secondary_links or $navbar) { print ' with-navbar'; } ?>">
	...
	<?php include('/afs/asu.edu/www/asuthemes/latest/includes/html/asu_footer.shtml'); ?>
